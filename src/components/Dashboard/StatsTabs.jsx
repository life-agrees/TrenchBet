 ...
 * Shows detailed betting statistics across different time periods
 */
const StatsTabs = ({ userBets = [] }) => {
  ...
  const calculateStats = () => {
    ...
    return {
      ...
      totalBetAmount,
      totalWinnings,
      winRate: filteredBets.length > 0 ? ((wins / (wins + losses)) * 100).toFixed(1) : 0
    };
  };
      ...
      <div className="p-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <p className={`text-2xl font-black ${stats.totalWinnings - stats.totalBetAmount >= 0 ? 'text-success' : 'text-red-400'}`}>
