...
const LandingHero = ({ isConnected }) => {
  return (
    <div className="flex flex-col items-center justify-center h-96 bg-white dark:bg-dark-800 rounded-2xl border-2 border-neutral-200 dark:border-dark-600">
      <div className="text-center">
        ...
        <h2 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">No Active Markets</h2>
