...
const NotificationCenter = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-end p-4">
      ...
      {/* Panel */}
      <div className="relative bg-dark-900 border-2 border-primary/30 rounded-2xl w-full max-w-md shadow-2xl animate-in slide-in-from-right duration-200 overflow-hidden">
