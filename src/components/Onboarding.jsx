...
import { ChevronRight, ChevronLeft, Wallet, TrendingUp, Gift, Shield, CheckCircle } from 'lucide-react';
...
const Step1Welcome = () => (
  <div className="text-center">
    ...
    <p className="text-gray-400 leading-relaxed">
      The most transparent prediction market on Base. 
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">Use MetaMask or Coinbase Wallet on Base network</p>
        </div>
      </div>
      <div className="flex items-start gap-4">
        <div className="w-8 h-8 bg-blue-500/20 rounded-full flex items-center justify-center flex-shrink-0">
...
const Step3GetUSDC = () => (
  <div className="text-center">
    ...
    <h2 className="text-2xl font-bold mb-4">Get USDC on Base</h2>
    <p className="text-gray-400 mb-6">
      You'll need USDC to place bets. Here are the best ways to get it:
    </p>
    <div className="space-y-3 text-left">
      <a href="https://bridge.base.org" target="_blank" rel="noopener noreferrer" className="block p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
        <div className="font-semibold">Base Bridge</div>
